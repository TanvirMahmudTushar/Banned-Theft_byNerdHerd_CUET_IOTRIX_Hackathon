...
function ManagerDashboard() {
    ...
    const [approvals, setApprovals] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [mealLogs, setMealLogs] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ManagerDashboard.useEffect": ()=>{
                ...
                "ManagerDashboard.useEffect.fetchData": async ()=>{
                    try {
                        const [statsData, approvalsData, logsData] = await Promise.all([
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getManagerStats"])(),
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getApprovals"])(),
                            fetch("http://127.0.0.1:8001/api/manager/meal-logs/today").then({
                                "ManagerDashboard.useEffect.fetchData": (res)=>res.json()
                            }["ManagerDashboard.useEffect.fetchData"])
                        ]);
                        // Patch mealLogs to include student_id_number and token_id from approvals if missing
                        const patchedMealLogs = logsData.map({
                            "ManagerDashboard.useEffect.fetchData.patchedMealLogs": (log)=>{
                                // Try to find matching approval for extra info
                                const approval = approvalsData.find({
                                    "ManagerDashboard.useEffect.fetchData.patchedMealLogs.approval": (a)=>a.student_id === log.student_id && a.requested_meal.toLowerCase() === log.meal_type.toLowerCase()
                                }["ManagerDashboard.useEffect.fetchData.patchedMealLogs.approval"]);
                                return {
                                    ...log,
                        ...
                        }["ManagerDashboard.useEffect.fetchData.patchedMealLogs"]);
                        setStats(statsData);
            ...
            return ({
                "ManagerDashboard.useEffect": ()=>clearInterval(interval)
            })["ManagerDashboard.useEffect"];
        }
    }["ManagerDashboard.useEffect"], []);
    const handleApprove = async (id)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["approveRequest"])(id);
    ...
    const handleDeny = async (id)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["denyRequest"])(id, "Denied by manager");
            setApprovals(approvals.filter((a)=>a.id !== id));
        } catch (err) {
            console.error(err);
        }
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            lineNumber: 180,
                            columnNumber: 13
                        }, this) : approvals.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "p-12 text-center",
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "text-zinc-400",
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        alreadyAte && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                ...
                                                alreadyAte && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ManagerDashboard, "l+D/0ZDMbzgjpYwd04QwwoAOKy4=");
_c = ManagerDashboard;
var _c;
...
//# sourceMappingURL=_40de75d2._.js.map